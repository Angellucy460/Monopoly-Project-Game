...
const Board = () => {
  ...
  // === TILE DATA ===
  const cornerTiles = {
    "0,10": "GO", "0,0": "JAIL", "10,0": "FREE PARKING", "10,10": "GO TO JAIL",
  };

  const tileLabels = {
    "0,9": "Mediterranean Ave", "0,8": "Chest", "0,7": "Baltic Ave",
    "0,6": "Tax", "0,5": "Reading RR", "0,4": "Oriental Ave", "0,3": "Chance",
    "0,2": "Vermont Ave", "0,1": "Connecticut", "1,0": "St. Charles", "2,0": "Electric",
    "3,0": "States Ave", "4,0": "Virginia", "5,0": "Penn RR", "6,0": "St. James",
    "7,0": "Chest", "8,0": "Tennessee", "9,0": "New York", "10,1": "Kentucky",
    "10,2": "Chance", "10,3": "Indiana", "10,4": "Illinois", "10,5": "B&O RR",
    "10,6": "Atlantic", "10,7": "Ventnor", "10,8": "Water", "10,9": "Marvin",
    "9,10": "Pacific", "8,10": "N Carolina", "7,10": "Chest", "6,10": "Penn Ave",
    "5,10": "Short Line", "4,10": "Chance", "3,10": "Park", "2,10": "Tax", "1,10": "Boardwalk",
  };
  ...
  const titleDeeds = [
    ...
    { name: "Oriental Ave", color: "light-blue", rent: 6, house1: 30, house2: 90, house3: 270, house4: 400, hotel: 550, mortgage: 50, houseCost: 50 },
              ...
              <div className="card-viewer" style={{ maxHeight: "90vh", overflowY: "auto", width: "18rem" }}>
                <Tabs activeKey={key} onSelect={(k) => setKey(k)} className="mb-3" justify>
                  <Tab eventKey="titledeeds" title="Title Deeds">
                    {titleDeeds.map((card, idx) => <TitleDeedCard key={idx} {...card} />)}
                  </Tab>
                  <Tab eventKey="chance" title="Chance">
                    {chanceCards.map((card, idx) => <ChanceCard key={idx} text={card.text} />)}
                  </Tab>
                  <Tab eventKey="chest" title="Community Chest">
                    {chestCards.map((card, idx) => <CommunityChestCard key={idx} text={card.text} />)}
                  </Tab>
                </Tabs>
              </div>
            )}
